      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 mt-6 md:mt-12">
        <div className="flex flex-1 py-6 border border-gray-200 rounded-sm">
          ...
          <div className="flex-1 pl-8">
            <div className="font-bold text-xl">Frete Gràtis</div>
            <div className="text-gray-500">Acima de R$ 99,00.</div>
          </div>
        </div>
        <div className="flex flex-1 py-6 border border-gray-200 rounded-sm">
          <div className="w-32 border-r border-gray-200  flex justify-center items-center ">
        ...
        <div className="flex flex-1 py-6 border border-gray-200 rounded-sm">
          ...
          <div className="flex-1 pl-8">
            <div className="font-bold text-xl">Troca Fàcil</div>
            <div className="text-gray-500">No perìodo de 30 dias.</div>
          </div>
        </div>
      </div>
